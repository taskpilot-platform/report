...
[Hình x: Kiến trúc tổng quan AI Copilot trong TaskPilot]
...
[Hình x: Sequence diagram tạo phiên chat và gửi tin nhắn AI]
...
[Hình x: Quy trình xây dựng ngữ cảnh cho AI Copilot]
...
| Nhóm yêu cầu | Hướng xử lý/routing | Ghi chú |
| --- | --- | --- |
...
[Hình x: Luồng smart routing trong AI Copilot]
...
[Hình x: Luồng auto fallback giữa các AI provider]
...
| Nhóm tool | Mục đích | Loại thao tác | Kiểm soát |
| --- | --- | --- | --- |
...
[Hình x: Mô hình Tool Calling Registry của AI Copilot]
...
[Hình x: Sequence diagram pending action confirmation cho thao tác AI ghi dữ liệu]
...
[Hình x: Các lớp kiểm soát an toàn trong AI Copilot]
...
[Hình x: Luồng ghi log và phản hồi cho AI Copilot]
...
| Pattern | Cách áp dụng trong AI Copilot | Lợi ích |
| --- | --- | --- |
...
[Hình x: Tổng hợp các design pattern trong AI Copilot]
