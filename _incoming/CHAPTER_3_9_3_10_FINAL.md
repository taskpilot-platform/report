...
[Hình x: Tổng quan cơ chế xác thực và phân quyền của TaskPilot]

### 3.9.1. Luồng đăng nhập và cấp JWT
...
[Hình x: Sequence diagram luồng đăng nhập và cấp JWT]
...
[Hình x: Luồng làm mới access token bằng refresh token]
...
[Hình x: Luồng logout và kiểm tra token blocklist]
...
[Hình x: Tổng quan thiết kế realtime và thông báo của TaskPilot]

### 3.10.1. Realtime notification bằng SSE
...
[Hình x: Sequence diagram realtime notification bằng SSE]
...
[Hình x: Luồng cập nhật comment và phát sự kiện realtime]

### 3.10.3. AI streaming response
...
[Hình x: Luồng AI streaming response từ Backend đến Frontend]
