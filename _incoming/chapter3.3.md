...
[Hình x: Sơ đồ System Context của hệ thống TaskPilot]
...
[Hình x: Luồng tương tác tổng quan giữa Frontend, Backend, Database, External Services và AI Provider]
...
[Hình x: Sơ đồ kiến trúc Frontend React SPA]

[Hình x: Luồng Frontend gọi REST API và nhận SSE từ Backend]
