...
hợp giữa module AI và các provider, giúp AI Copilot gọi tool, stream phản hồi và
giảm phụ thuộc trực tiếp vào một nhà cung cấp cụ thể.
...
dùng qua endpoint tương thích OpenAI [15]. TaskPilot sử dụng Groq như một
