...
Sprint và các hoạt động kiểm tra định kỳ [2]. Backlog chứa các hạng mục cần thực
hiện; Sprint là chu kỳ ngắn để nhóm chọn một phần backlog và hoàn thành theo mục
tiêu đã thống nhất. Các khái niệm này tương ứng trực tiếp với mô hình dự án,
sprint và task trong TaskPilot.

#figure(
  pad(bottom: -2em, image(
    "../../assets/taskpilot/chapter2/ch2_02_scrum_sprint.svg",
    width: 100%,
  )),
