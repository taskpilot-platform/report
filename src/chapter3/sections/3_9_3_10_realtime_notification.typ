...
Luồng đăng nhập cơ bản đã được trình bày trong đặc tả UC01 tại mục 3.5.1. Phần
này tập trung vào cơ chế cấp token, duy trì phiên, thu hồi token và kiểm soát
quyền sau khi người dùng đã được xác thực.
