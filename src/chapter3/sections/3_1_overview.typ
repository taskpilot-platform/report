...
#figure(
  image("../../assets/taskpilot/chapter3/ch3_01_jira_workflow.jpg", width: 100%),
...
#figure(
  image("../../assets/taskpilot/chapter3/ch3_01_trello_kanban.jpg", width: 100%),
...
#align(center)[#emph[Bảng 3.1: Bảng so sánh các công cụ quản lý dự án và định hướng của TaskPilot]]
