...
#figure(
  image("../../assets/taskpilot/chapter3/ch3_02_analysis_design_process.svg", width: 100%),
...
#figure(
  image("../../assets/taskpilot/chapter3/ch3_02_testing_deployment_process.svg", width: 100%),
