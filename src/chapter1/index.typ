...
Trong bối cảnh công nghệ thông tin phát triển mạnh mẽ, nhu cầu quản lý dự án phần
mềm một cách chuyên nghiệp và linh hoạt ngày càng trở nên cấp thiết. Sự gia tăng
về quy mô dự án, tính phức tạp của yêu cầu kinh doanh, và xu hướng làm việc linh
hoạt đòi hỏi các nhóm phát triển phải có những công cụ hỗ trợ để phối hợp hiệu
quả.

Tuy nhiên, trong quá trình quản lý công việc, theo dõi tiến độ và điều phối thành
viên, nhiều tổ chức vẫn gặp phải những khó khăn nhất định. Các công cụ quản lý
truyền thống hoặc quy trình phân công thủ công thường bộc lộ hạn chế như: thao
tác lặp đi lặp lại tốn thời gian, khó khăn trong việc tổng hợp dữ liệu năng lực
để giao việc cho đúng người, và thiếu một cơ chế hỗ trợ tự động hóa thông minh
giúp người quản lý ra quyết định.
...
ngữ tự nhiên mà còn có thể tương tác trực tiếp với hệ thống để thực hiện các thao
tác phức tạp, từ việc truy vấn thông tin tiến độ đến đưa ra các gợi ý phân công
công việc khách quan dựa trên dữ liệu thực tế.
...
hướng đến việc cung cấp một môi trường làm việc hợp nhất giúp các nhóm phát triển
phần mềm theo dõi công việc hiệu quả, cải thiện khả năng cộng tác theo thời gian
thực, đồng thời tự động hóa và tối ưu hóa các quy trình quản lý thông qua sự hỗ
trợ của trí tuệ nhân tạo.
...
- Xây dựng cơ chế tự động gợi ý phân công công việc dựa trên phương pháp tính
  điểm (heuristic scoring) kết hợp đánh giá mức độ phù hợp về kỹ năng, khối lượng
...
- *Ứng dụng web:* Công nghệ xây dựng giao diện người dùng đơn trang tương tác
  cao.
- *AI Agent:* Các phương pháp tích hợp mô hình ngôn ngữ lớn, quản lý ngữ cảnh hội
  thoại và kiểm soát an toàn khi AI thay đổi dữ liệu.
...
Hệ thống được thiết kế theo kiến trúc Modular Monolith cho backend và Single Page
Application (SPA) cho frontend. Đề tài tập trung vào việc áp dụng Function
...
Retrieval-Augmented Generation (RAG) hoặc hệ thống tự động học sở thích (Adaptive
Preference Learning) nằm ngoài phạm vi thực hiện hiện tại và được xem xét như các
...
hóa các thao tác cập nhật dữ liệu. Mọi hành động thay đổi dữ liệu của AI đều trải
qua bước chờ xác nhận từ người dùng để đảm bảo tính an toàn.
...
thống chấm điểm tổng hợp, hệ thống đưa ra danh sách các ứng viên phù hợp nhất kèm
theo giải thích chi tiết để người quản lý dễ dàng ra quyết định.
