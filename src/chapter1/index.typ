...
công công việc dựa trên dữ liệu kỹ năng, workload và trọng số đã xác định.
...
triển phần mềm theo dõi công việc, hỗ trợ cộng tác theo thời gian thực, đồng
thời tự động hóa một số quy trình quản lý thông qua sự hỗ trợ của trí tuệ nhân
tạo.
...
- Thiết kế và triển khai kiến trúc phân module, hỗ trợ bảo trì, mở rộng chức
  năng ở mức thiết kế và xử lý các kết nối theo thời gian thực.
...
#figure(
  table(
    ...
    [*Hạ tầng triển khai*],
    [Docker, Netlify, Hugging Face Space, GitHub Actions],
